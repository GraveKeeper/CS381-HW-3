...
isNice (End) = False
isNice (And x y) = (isNice x) && (isNice y)
...
wordCount (NVN n1 v1 n2) = nounCount n1 + nounCount n2 + 1
wordCount (NV n1 v1) = nounCount n1 + 1
wordCount End = 0

nounCount :: Noun -> Int
nounCount (NP a1 n1) = nounCount n1 + 1
nounCount (NAnd n1 n2) = nounCount n1 + nounCount n2 + 1
nounCount _ = 1